...
<script>
	...
	$: $walletStore.connected && $walletStore.publicKey && $workSpace?.connection &&
...
<footer class="footer footer-center p-10 bg-gray-200 dark:bg-gray-900 text-base-content rounded">
