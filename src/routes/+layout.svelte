...
<SvelteToast {options} />
<div class="min-h-screen bg-accent-light dark:bg-brand-dark">
	<Nav />
	<main class="container mx-auto px-4 py-8">
		<slot />
	</main>
</div>
<footer class="footer footer-center rounded bg-accent-light p-10 text-base-content dark:bg-brand-dark">
	<div class="grid grid-flow-col gap-4">
		<a class="text-secondary transition hover:text-secondary-dark dark:text-accent dark:hover:text-accent-light" href="/">Home</a>
		<a class="text-secondary transition hover:text-secondary-dark dark:text-accent dark:hover:text-accent-light" href="/about">About</a>
	</div>
	<div>
		<div class="grid grid-flow-col gap-4">
			<a class="text-secondary transition hover:text-secondary-dark dark:text-accent dark:hover:text-accent-light"
			   target="_blank"
	...
	<div>
		<p class="text-secondary dark:text-accent">Copyright © 2023 - All right reserved by MonkeDAO</p>
	</div>
</footer>
