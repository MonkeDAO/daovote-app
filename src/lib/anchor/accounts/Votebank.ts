...
export class Votebank implements VotebankArgs {
	 ...
	 */
	static fromAccountInfo(accountInfo: web3.AccountInfo<Buffer>, offset = 0): [Votebank, number] {
	...
	static async getMinimumBalanceForRentExemption(
		...
		return connection.getMinimumBalanceForRentExemption(Votebank.byteSize(args), commitment);
	}
