...
<label for="confirmation-modal" class="btn hidden">Open modal</label>

<input type="checkbox" id="confirmation-modal" class="modal-toggle" bind:this={modalInput} />
<div class="modal">
	<div class="modal-box bg-gray-100 dark:bg-gray-900">
		...
		<div class="modal-action">
			<label for="confirmation-modal" class="btn-error btn">Cancel</label>
